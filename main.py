...
# Intento de volver a ingresar v1 cuando ya está en el taller para probar la validación del método ingresar()
# Nota: Esta línea detendrá la ejecución al detectar que v1 ya se encuentra en el taller
v1.ingresar()
